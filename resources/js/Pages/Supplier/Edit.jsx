...
export default function Edit({ auth, supplier, products, linkedProductIds }) {
    ...
    return (
        <ModuleLayout currentModule="suppliers" breadcrumbs={crumbs}>
            ...
            <div className="bg-white border border-gray-200 rounded-xl p-5 mb-6 shadow-sm flex items-center justify-between">
                <div>
                    <h1 className="text-xl font-bold text-gray-900 font-display">Edit Supplier: {supplier.name}</h1>
                    <p className="text-xs text-gray-500 mt-1">Modify supplier settings or associated catalog maps</p>
                </div>
                <Link
