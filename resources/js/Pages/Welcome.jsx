...
export default function Welcome({ auth }) {
    return (
        <div className="relative min-h-screen flex items-center justify-center bg-slate-950 overflow-hidden font-sans p-4 sm:p-6 md:p-8">
            ...
            {/* Backdrop Image with Scale and Full Screen Glass Overlay */}
            <div className="absolute inset-0 z-0">
                ...
                />
                <div className="absolute inset-0 bg-slate-950/45 backdrop-blur-[5px] z-0" />
            </div>
            ...
            {/* Welcome Wrapper (Hovering directly on the glass background) */}
            <div className="relative z-10 w-full max-w-4xl px-4 sm:px-6 md:px-8">

                {/* Status bar top row */}
                <div className="flex items-center justify-between mb-8 pb-6 border-b border-white/10 text-[10px] tracking-widest text-indigo-300 font-bold uppercase animate-fade-in">
                ...
                <div className="flex flex-col items-center text-center mb-10">
                    <div className="w-16 h-16 rounded-2xl bg-white/5 border border-white/15 shadow-xl flex items-center justify-center mb-6 group hover:border-indigo-400/50 transition-all duration-300 hover:scale-105 animate-fade-in-up delay-100">
                        <i className="ri-box-3-line text-white text-3xl animate-pulse-slow" />
                    </div>
                    
                    <span className="text-[10px] font-bold text-indigo-400 tracking-[0.3em] uppercase mb-2 animate-fade-in-up delay-150">
                        Zimbabwe Logistics & Catalog Engine
                    </span>
                    
                    <h1 className="text-3xl sm:text-5xl font-black text-white tracking-tight leading-none mb-6 animate-fade-in-up delay-200">
                    ...
                    <p className="max-w-xl text-sm sm:text-base text-slate-300 leading-relaxed mb-2 animate-fade-in-up delay-250">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-10">
                    ...
                    {/* Item 1 */}
                    <div className="bg-white/[0.02] backdrop-blur-sm border border-white/5 rounded-2xl p-5 text-left transition-all hover:bg-white/[0.05] hover:border-white/15 hover:-translate-y-0.5 group animate-fade-in-up delay-300">
                    ...
                    {/* Item 2 */}
                    <div className="bg-white/[0.02] backdrop-blur-sm border border-white/5 rounded-2xl p-5 text-left transition-all hover:bg-white/[0.05] hover:border-white/15 hover:-translate-y-0.5 group animate-fade-in-up delay-350">
                        <div className="w-9 h-9 rounded-xl bg-indigo-500/10 flex items-center justify-center mb-4 text-indigo-400 group-hover:bg-indigo-500/20 group-hover:text-indigo-300 transition-all">
                    ...
                    {/* Item 3 */}
                    <div className="bg-white/[0.02] backdrop-blur-sm border border-white/5 rounded-2xl p-5 text-left transition-all hover:bg-white/[0.05] hover:border-white/15 hover:-translate-y-0.5 group animate-fade-in-up delay-400">
                        <div className="w-9 h-9 rounded-xl bg-indigo-500/10 flex items-center justify-center mb-4 text-indigo-400 group-hover:bg-indigo-500/20 group-hover:text-indigo-300 transition-all">
                ...
                {/* Footnote */}
                <div className="mt-10 pt-6 border-t border-white/10 text-center text-[10px] text-slate-500 tracking-wider animate-fade-in delay-600">
                    Designed with love by darlingtonhp
                </div>
            </div>
        </div>
    );
